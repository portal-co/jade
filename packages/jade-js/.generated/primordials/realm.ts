...
export function* createPrimordialRealm(tenant: Tenant, options: PrimordialRealmOptions): TenantGenerator<PrimordialRealm> {
    ...
    const realm: PrimordialRealm = {
        ...
        promiseRuntime: promises.promiseRuntime,
        typedArrays: new Map()
    };
    for (const [key, value] of Object.entries({
        Object: realm.Object,
        Function: realm.Function,
        Reflect: realm.Reflect,
        Proxy: realm.Proxy,
