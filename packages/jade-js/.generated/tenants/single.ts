...
import { isCamoKey, type Tenant, type TenantCallableExoticHandler, type TenantExoticHandler, type TenantInvocation, type TenantPropertyDescriptor } from "./types.ts";
...
export const single_tenant: Tenant & {
    ...
    *invoke (callee: Function, invocation: TenantInvocation) {
        ...
        return yield this.yieldTenant(this.invokeGuestAware(callee, invocation.kind === "apply" ? invocation.thisArg : undefined, invocation.args, invocation));
    },
    ...
    *defineProperty (obj: object, key: PropertyKey, descriptor: TenantPropertyDescriptor) {
        ...
        try {
            ...
            Object.defineProperty(obj, clean(obj as any, key as any) as any, out);
            return true;
        } catch (error) {
    ...
    *define (target: object, descriptors: object) {
        ...
        for (const k of keys as PropertyKey[]){
            Object.defineProperty(target, clean(target as any, k as any) as any, (yield this.yieldTenant(this.get(descriptors, k))) as PropertyDescriptor);
        }
    },
